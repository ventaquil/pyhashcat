...
static void event(const u32 id, hashcat_ctx_t *hashcat_ctx, const void *buf, const size_t len) {
    ...
    switch (id) {
    case EVENT_AUTOTUNE_FINISHED:
        size = asprintf(&esignal, "%s", "EVENT_AUTOTUNE_FINISHED");
        break;
    case EVENT_AUTOTUNE_STARTING:
        size = asprintf(&esignal, "%s", "EVENT_AUTOTUNE_STARTING");
        break;
    case EVENT_BITMAP_INIT_POST:
        size = asprintf(&esignal, "%s", "EVENT_BITMAP_INIT_POST");
        break;
    case EVENT_BITMAP_INIT_PRE:
        size = asprintf(&esignal, "%s", "EVENT_BITMAP_INIT_PRE");
        break;
    case EVENT_BITMAP_FINAL_OVERFLOW:
        size = asprintf(&esignal, "%s", "EVENT_BITMAP_FINAL_OVERFLOW");
        break;
    case EVENT_CALCULATED_WORDS_BASE:
        size = asprintf(&esignal, "%s", "EVENT_CALCULATED_WORDS_BASE");
        break;
    case EVENT_CRACKER_FINISHED:
        size = asprintf(&esignal, "%s", "EVENT_CRACKER_FINISHED");
        break;
    case EVENT_CRACKER_HASH_CRACKED:
        size = asprintf(&esignal, "%s", "EVENT_CRACKER_HASH_CRACKED");
        break;
    case EVENT_CRACKER_STARTING:
        size = asprintf(&esignal, "%s", "EVENT_CRACKER_STARTING");
        break;
    case EVENT_HASHLIST_COUNT_LINES_POST:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_COUNT_LINES_POST");
        break;
    case EVENT_HASHLIST_COUNT_LINES_PRE:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_COUNT_LINES_PRE");
        break;
    case EVENT_HASHLIST_PARSE_HASH:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_PARSE_HASH");
        break;
    case EVENT_HASHLIST_SORT_HASH_POST:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_SORT_HASH_POST");
        break;
    case EVENT_HASHLIST_SORT_HASH_PRE:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_SORT_HASH_PRE");
        break;
    case EVENT_HASHLIST_SORT_SALT_POST:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_SORT_SALT_POST");
        break;
    case EVENT_HASHLIST_SORT_SALT_PRE:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_SORT_SALT_PRE");
        break;
    case EVENT_HASHLIST_UNIQUE_HASH_POST:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_UNIQUE_HASH_POST");
        break;
    case EVENT_HASHLIST_UNIQUE_HASH_PRE:
        size = asprintf(&esignal, "%s", "EVENT_HASHLIST_UNIQUE_HASH_PRE");
        break;
    case EVENT_INNERLOOP1_FINISHED:
        size = asprintf(&esignal, "%s", "EVENT_INNERLOOP1_FINISHED");
        break;
    case EVENT_INNERLOOP1_STARTING:
        size = asprintf(&esignal, "%s", "EVENT_INNERLOOP1_STARTING");
        break;
    case EVENT_INNERLOOP2_FINISHED:
        size = asprintf(&esignal, "%s", "EVENT_INNERLOOP2_FINISHED");
        break;
    case EVENT_INNERLOOP2_STARTING:
        size = asprintf(&esignal, "%s", "EVENT_INNERLOOP2_STARTING");
        break;
    case EVENT_LOG_ERROR:
        size = asprintf(&esignal, "%s", "EVENT_LOG_ERROR");
        break;
    case EVENT_LOG_INFO:
        size = asprintf(&esignal, "%s", "EVENT_LOG_INFO");
        break;
    case EVENT_LOG_WARNING:
        size = asprintf(&esignal, "%s", "EVENT_LOG_WARNING");
        break;
    case EVENT_LOG_ADVICE:
        size = asprintf(&esignal, "%s", "EVENT_LOG_ADVICE");
        break;
    case EVENT_MONITOR_RUNTIME_LIMIT:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_RUNTIME_LIMIT");
        break;
    case EVENT_MONITOR_STATUS_REFRESH:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_STATUS_REFRESH");
        break;
    case EVENT_MONITOR_TEMP_ABORT:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_TEMP_ABORT");
        break;
    case EVENT_MONITOR_THROTTLE1:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_THROTTLE1");
        break;
    case EVENT_MONITOR_THROTTLE2:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_THROTTLE2");
        break;
    case EVENT_MONITOR_THROTTLE3:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_THROTTLE3");
        break;
    case EVENT_MONITOR_PERFORMANCE_HINT:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_PERFORMANCE_HINT");
        break;
    case EVENT_MONITOR_NOINPUT_HINT:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_NOINPUT_HINT");
        break;
    case EVENT_MONITOR_NOINPUT_ABORT:
        size = asprintf(&esignal, "%s", "EVENT_MONITOR_NOINPUT_ABORT");
        break;
    case EVENT_BACKEND_SESSION_POST:
        size = asprintf(&esignal, "%s", "EVENT_BACKEND_SESSION_POST");
        break;
    case EVENT_BACKEND_SESSION_PRE:
        size = asprintf(&esignal, "%s", "EVENT_BACKEND_SESSION_PRE");
        break;
    case EVENT_BACKEND_DEVICE_INIT_POST:
        size = asprintf(&esignal, "%s", "EVENT_BACKEND_SESSION_PRE");
        break;
    case EVENT_BACKEND_DEVICE_INIT_PRE:
        size = asprintf(&esignal, "%s", "EVENT_BACKEND_SESSION_PRE");
        break;
    case EVENT_OUTERLOOP_FINISHED:
        size = asprintf(&esignal, "%s", "EVENT_OUTERLOOP_FINISHED");
        break;
    case EVENT_OUTERLOOP_MAINSCREEN:
        size = asprintf(&esignal, "%s", "EVENT_OUTERLOOP_MAINSCREEN");
        break;
    case EVENT_OUTERLOOP_STARTING:
        size = asprintf(&esignal, "%s", "EVENT_OUTERLOOP_STARTING");
        break;
    case EVENT_POTFILE_ALL_CRACKED:
        size = asprintf(&esignal, "%s", "EVENT_POTFILE_ALL_CRACKED");
        break;
    case EVENT_POTFILE_HASH_LEFT:
        size = asprintf(&esignal, "%s", "EVENT_POTFILE_HASH_LEFT");
        break;
    case EVENT_POTFILE_HASH_SHOW:
        size = asprintf(&esignal, "%s", "EVENT_POTFILE_HASH_SHOW");
        break;
    case EVENT_POTFILE_NUM_CRACKED:
        size = asprintf(&esignal, "%s", "EVENT_POTFILE_NUM_CRACKED");
        break;
    case EVENT_POTFILE_REMOVE_PARSE_POST:
        size = asprintf(&esignal, "%s", "EVENT_POTFILE_REMOVE_PARSE_POST");
        break;
    case EVENT_POTFILE_REMOVE_PARSE_PRE:
        size = asprintf(&esignal, "%s", "EVENT_POTFILE_REMOVE_PARSE_PRE");
        break;
    case EVENT_SELFTEST_FINISHED:
        size = asprintf(&esignal, "%s", "EVENT_SELFTEST_FINISHED");
        break;
    case EVENT_SELFTEST_STARTING:
        size = asprintf(&esignal, "%s", "EVENT_SELFTEST_STARTING");
        break;
    case EVENT_SET_KERNEL_POWER_FINAL:
        size = asprintf(&esignal, "%s", "EVENT_SET_KERNEL_POWER_FINAL");
        break;
    case EVENT_WORDLIST_CACHE_GENERATE:
        size = asprintf(&esignal, "%s", "EVENT_WORDLIST_CACHE_GENERATE");
        break;
    case EVENT_WORDLIST_CACHE_HIT:
        size = asprintf(&esignal, "%s", "EVENT_WORDLIST_CACHE_HIT");
        break;
    }
...
static hashcatObject *newhashcatObject(PyObject *arg) {
    hashcatObject *self = PyObject_New(hashcatObject, &hashcat_Type);
    if (self == NULL) {
        return NULL;
    }
...
static void *hc_session_exe_thread(void *params) {
    ...
    int rtn = hashcat_session_execute(self->hashcat_ctx);
    if (rtn) { // fixme what the hell?
        rtn = rtn;
    }
...
static PyObject *hashcat_hashcat_session_pause(hashcatObject *self, PyObject *noargs) {
    int rtn = hashcat_session_pause(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_hashcat_session_resume(hashcatObject *self, PyObject *noargs) {
    int rtn = hashcat_session_resume(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_hashcat_session_bypass(hashcatObject *self, PyObject *noargs) {
    int rtn = hashcat_session_bypass(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_hashcat_session_checkpoint(hashcatObject *self, PyObject *noargs) {
    int rtn = hashcat_session_checkpoint(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_hashcat_session_quit(hashcatObject *self, PyObject *noargs) {
    int rtn = hashcat_session_quit(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
    ...
    if (hc_status == 0) {
        ...
        if (hwmon_ctx->enabled == true) {
            ...
            for (int device_id = 0; device_id < hashcat_status->device_info_cnt; device_id++) {
                ...
                if (device_info->skipped_warning_dev == true) {
                    continue;
                }
...
static int sort_by_usage(const void *p1, const void *p2) {
    ...
    if (u1->hash_category > u2->hash_category) {
        return 1;
    }
    if (u1->hash_category < u2->hash_category) {
        return -1;
...
static PyObject *hashcat_status_get_device_info_cnt(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_device_info_cnt(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_device_info_active(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_device_info_active(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_skipped_dev(hashcatObject *self, PyObject *args) {
    ...
    bool rtn = status_get_skipped_dev(self->hashcat_ctx, device_id);
...
static PyObject *hashcat_status_get_log(hashcatObject *self, PyObject *noargs) {
    char *rtn = hashcat_get_log(self->hashcat_ctx);
...
static PyObject *hashcat_status_get_session(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_session(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_status_string(hashcatObject *self, PyObject *noargs) {
    const char *rtn = status_get_status_string(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_status_number(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_status_number(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_mode(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_guess_mode(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_base(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_guess_base(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_guess_base_offset(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_guess_base_offset(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_base_count(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_guess_base_count(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_base_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_guess_base_percent(self->hashcat_ctx);
...
static PyObject *hashcat_status_get_guess_mod(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_guess_mod(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_guess_mod_offset(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_guess_mod_offset(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_mod_count(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_guess_mod_count(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_mod_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_guess_mod_percent(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_guess_charset(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_guess_charset(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_guess_mask_length(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_guess_mask_length(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_guess_candidates_dev(hashcatObject *self, PyObject *args) {
    ...
    char *rtn = status_get_guess_candidates_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_hash_name(hashcatObject *self, PyObject *noargs) {
    const char *rtn = status_get_hash_name(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_hash_target(hashcatObject *self, PyObject *noargs) {
    const char *rtn = status_get_hash_target(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_digests_done(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_digests_done(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_digests_cnt(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_digests_cnt(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_digests_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_digests_percent(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_salts_done(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_salts_done(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_salts_cnt(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_salts_cnt(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_salts_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_salts_percent(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_msec_running(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_msec_running(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_msec_paused(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_msec_paused(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_msec_real(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_msec_real(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_time_started_absolute(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_time_started_absolute(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_time_started_relative(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_time_started_relative(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_time_estimated_absolute(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_time_estimated_absolute(self->hashcat_ctx);
...
static PyObject *hashcat_status_get_time_estimated_relative(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_time_estimated_relative(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_restore_point(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_restore_point(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_restore_total(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_restore_total(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_restore_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_restore_percent(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_progress_mode(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_progress_mode(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_finished_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_progress_finished_percent(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_progress_done(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_done(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_rejected(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_rejected(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_rejected_percent(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_progress_rejected_percent(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_progress_restored(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_restored(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_cur(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_cur(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_end(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_end(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_ignore(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_ignore(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_skip(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_skip(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_cur_relative_skip(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_cur_relative_skip(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_end_relative_skip(hashcatObject *self, PyObject *noargs) {
    u64 rtn = status_get_progress_end_relative_skip(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_hashes_msec_all(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_hashes_msec_all(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_hashes_msec_dev(hashcatObject *self, PyObject *args) {
    ...
    double rtn = status_get_hashes_msec_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_hashes_msec_dev_benchmark(hashcatObject *self, PyObject *args) {
    ...
    double rtn = status_get_hashes_msec_dev_benchmark(self->hashcat_ctx, device_id);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_exec_msec_all(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_exec_msec_all(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_exec_msec_dev(hashcatObject *self, PyObject *args) {
    ...
    double rtn = status_get_exec_msec_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_speed_sec_all(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_speed_sec_all(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_speed_sec_dev(hashcatObject *self, PyObject *args) {
    ...
    char *rtn = status_get_speed_sec_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_cpt_cur_min(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_cpt_cur_min(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_cpt_cur_hour(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_cpt_cur_hour(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_cpt_cur_day(hashcatObject *self, PyObject *noargs) {
    int rtn = status_get_cpt_cur_day(self->hashcat_ctx);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_cpt_avg_min(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_cpt_avg_min(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_cpt_avg_hour(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_cpt_avg_hour(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_cpt_avg_day(hashcatObject *self, PyObject *noargs) {
    double rtn = status_get_cpt_avg_day(self->hashcat_ctx);
    return Py_BuildValue("d", rtn);
}
...
static PyObject *hashcat_status_get_cpt(hashcatObject *self, PyObject *noargs) {
    char *rtn = status_get_cpt(self->hashcat_ctx);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_hwmon_dev(hashcatObject *self, PyObject *args) {
    ...
    char *rtn = status_get_hwmon_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("s", rtn);
}
...
static PyObject *hashcat_status_get_corespeed_dev(hashcatObject *self, PyObject *args) {
    ...
    int rtn = status_get_corespeed_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_memoryspeed_dev(hashcatObject *self, PyObject *args) {
    ...
    int rtn = status_get_memoryspeed_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_progress_dev(hashcatObject *self, PyObject *args) {
    ...
    int rtn = status_get_progress_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("i", rtn);
}
...
static PyObject *hashcat_status_get_runtime_msec_dev(hashcatObject *self, PyObject *args) {
    ...
    double rtn = status_get_runtime_msec_dev(self->hashcat_ctx, device_id);
    return Py_BuildValue("d", rtn);
}
...
static int hashcat_setseparator(hashcatObject *self, PyObject *value, void *closure) {
    ...
    char sep = (PyUnicode_ReadChar(value, 0));
